...
export const TestCaseForm = () => (
  <form className={style['test-case-form']}>
    <Input name="id" type="text" label="Test Case ID" required />
    <Input name="name" type="text" label="Test Case Name" required />
    <Input name="description" type="text" multiline={true} floating={true} rows={3} label="Test Case Description" required />
